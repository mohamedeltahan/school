                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-3 col-xs-12 pull-right">
                                <a class="btn btn-primary btn-block" href="{{route("students.create")}}">اضافة طالب</a>
                                ...
                                <form method="post" action="{{route("schools.destroy",$school->id)}}">
                                    ...
                                    <button class="btn btn-danger btn-block confirm-delete"  type="submit"> حذف المدرسة
                                    </button>
                            ...
                            @foreach($students as $student)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{route('students.edit',$student->id)}}" type="button" class="btn btn-warning btn-xs">تعديل
                                        </a>
                                        <form method="post" action="{{route("students.destroy",$student->id)}}" style="display:inline">
                                            ...
                                            <input type="hidden" name="book_id" value="<?php echo 1;?>">
                                            <input type="submit" class="btn btn-danger btn-xs confirm-delete"
                                                   data-confirm-dname="<?php echo 'الطالب محمد احمد';?>" value="حذف">
                                        </form>
                                    </td>
                                </tr>
                            @endforeach
                    ...
                    <div class="table-container">
                        <table class="table table-striped text-center">
                            ...
                            @foreach($supports as $support)
                                <tr>
                                    <td class="text-center">1</td>
                                    <td class="text-center"><a href="{{route("technical_users.show",$support->id)}}">{{$support->full_name}}</a></td>
                                    <td>
                                    ...
                                    <td>
                                        <a href="{{route('technical_users.edit',$support->id)}}" type="button" class="btn btn-warning btn-xs">تعديل
                                        </a>
                                        <form method="post" action="{{route("delete_support")}}" style="display:inline">
                                            @csrf
