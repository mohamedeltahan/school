					...
					<div class="row">
						...
						<div class="col-md-6" style="padding: 25px;">
							...
							<div class="form-group">
								...
								<input name="mother_village" type="text" class="form-control text-right" placeholder="ادخل القرية التابعة لها المدرسة">
							</div><!-- /.form-group -->
							...
							<!-- There is an error in the namming
								the created way isnot seted right
							-->
							<!-- how the school build -->
							<div class="form-group">
								<label><span style="color:red;">*</span> طريقة الانشاء</label>
								<br>
								<label><input value="option1" type="radio" name="created_way_option" required> جهة وزارية</label><br>
								<label><input value="option2" type="radio" name="created_way_option">جهة داعمة</label><br>
								<label><input value="option4" type="radio" name="created_way_option">جمعيات اهلية/مؤسسات</label><br>
								<label><input value="option3" type="radio" name="created_way_option">جهود اهلية</label><br>
							</div><!-- /.form-group -->
							<!-- how the school build -->

							<input type="hidden" class="created_way_select_options created_way_option3" name="" value="جهة اهلية">

							<div class="form-grop created_way_select_options created_way_option4">
								<label>اسم الجمعية الاهلية/المؤسسة</label>
								<input type="text" class="form-control" placeholder="ادخل اسم الجمعية الاهلية او المؤسسة">
							</div><!-- /.form-grop -->
