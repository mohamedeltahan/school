					...
					<div class="row">
						...
						<div class="col-md-6" style="padding:25px;">
							...
							<div class="form-group">
								...
								<input value="{{$school->mother_village}}" name="mother_village" type="text" class="form-control text-right" required placeholder="ادخل القرية التابعة لها المدرسة">
							</div><!-- /.form-group -->
