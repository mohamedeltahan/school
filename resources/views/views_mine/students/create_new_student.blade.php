                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="full_name" class="form-control text-right" required="required" placeholder="ادخل اسم الطالب">
                            </div><!-- /.form-group -->

                            <div class="form-group">
                                <label><span style="color:red">*</span>تاريخ الميلاد</label>
                                <input type="text" name="birth_date" class="form-control text-right birth-date-input-field" required="required" placeholder="ادخل تاريخ الميلاد">
                            </div><!-- /.form-group -->
                            ...
                            <div class="form-group">
                                ...
                                <select name="social_status"  required="required" class="form-control text-right child_state_options">
                            ...
                            <div class="child-family-state">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="relation[]" placeholder="ادخل اسم ولي الامر">
                                </div><!-- /.form-group -->
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="relation[]" placeholder="ادخل رقم الهاتف لولي الامر">
                                </div><!-- /.form-group -->
                            ...
                            <div class="form-group">
                                ...
                                <input  type="password" class="form-control text-right" required="required" placeholder="اعد كلمة السر">
                            </div><!-- /.form-group -->
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control birth-date-input-field" name="entry_date" placeholder="ادخل تاريخ الدخول للطالب">
                            </div><!-- /.form-group -->
                            ...
                            <div class="form-group">
                                ...
                                <input name="ssn" type="text" class="form-control text-right" required="required" placeholder="ادخل رقم شهادة ميلاد الطالب">
                            </div><!-- /.form-group -->

                            <div class="form-group">
                                <label>موهبة الطالب</label>
                                <br>
                                <select  name="talent" dir="ltr" class=" text-" id="talent-multie-select" multiple="multiple">
                            ...
                            <div class="form-group" >
                                ...
                                <textarea name="address" rows="5" class="form-control text-right" style="resize: none;" required placeholder="ادخل العنوان بالتفصيل"></textarea>
                            </div><!-- /.form-group -->
                            ...
                            <div class="form-group custome-mine-table">
                                ...
                                <table class="table table-striped table-condensed">
                                    ...
                                    @foreach($schools as $school)
                                        <tr>
                                            <td class="text-right">
                                                <input name="school_id" value="{{$school->id}}" required name="school" type="radio">
                                            </td>
                                            <td>
                                                {{$school->name}}
                                            </td>
