                ...
                <form method="post" action="{{route("technical_users.store")}}">
                    ...
                    <div class="form-group text-right">
                        ...
                        <select name="user_category" class="form-control text-right" id="flag-investor">
                            <option @if() {}@endif class=" text-right" value="مدير نظام" selected="selected">
                                مدير نظام
                            </option>
                    ...
                    <div class="form-group technichal-support-options">
                        ...
                        <input name="birth_date" type="text" class="form-control text-right birth-date-input-field" required="required" placeholder="ادخل تاريخ الميلاد">
                    </div><!-- /.form-group -->
                    <div class="form-group technichal-support-options">
                    ...
                    <div class="form-group technichal-support-options">
                        ...
                        <input name="phone" type="text" class="form-control text-right" required="required" placeholder="ادخل الرقم القومي للمعلمة">
                    </div><!-- /.form-group -->
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="address" rows="5" class="form-control" style="resize: none;" required="required" placeholder="ادخل العنوان بالتفصيل"></textarea>
                    </div><!-- /.form-group -->
                ...
                <div class="modal-body chosse-school-table">
                    <table class="table table-striped  table-condensed">
                      ...
                      <tr>
                        ...
                        <td class="text-right">مدرسة النور</td>
                        <td class="text-right">الجيزة</td>
                        <td class="text-right"><input type="checkbox" name="foo" data-checkbox-children="school-lists"></td>
                      </tr>
                      <tr>
                        <td class="text-right">1</td>
                        <td class="text-right">مدرسة النور</td>
