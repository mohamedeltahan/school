            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-3 text-center">
                        <img src='{{asset("storage/teachers/$teacher->id/pp.jpg")}}'
                        ...
                        <div class="teacher-profile-controler">
                            ...
                            <button type="button" class="btn btn-primary btn-block" data-toggle="modal"
                                    data-target=".upload-id-model">اضافة ملف رسمي
                            </button>
                            ...
                            @if(\Illuminate\Support\Facades\Auth::check() && \Illuminate\Support\Facades\Auth::user()->can("تعديل معلمة"))
                                ...
                                <a href="{{route("teachers.edit",$teacher->id)}}" class="btn btn-warning btn-block">تعديل
                                    بيانات المعلمة</a>
                            @endif
                    ...
                    @foreach($files as $file)
                        <tr>
                            ...
                            <td>
                                ...
                                <form method="post" action="{{route("teachers_files.destroy",$file->id)}}"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    <form method="post" action="{{route("teachers_files.store")}}" class="form-container-small"
