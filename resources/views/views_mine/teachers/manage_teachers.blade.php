    ...
    <div class="container-fluid">
        ...
        <div class="row add-account-btn">
            @if(\Illuminate\Support\Facades\Auth::check() && \Illuminate\Support\Facades\Auth::user()->can("اضافة معلمة"))
                ...
                <div class="col-md-12">
                    <a href='{{route("teachers.create")}}' class="btn btn-primary pull-left">اضافة معلمة جديدة</a>
                </div><!-- /.col-md-12 -->
            @endif
        </div><!-- /.row -->
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                        ...
                        @foreach($schools as $school)
                            ...
                            <tr>
                                <td class="text-right"><a
                                            href='{{route('teachers.show',$teacher->id)}}'>{{ $teacher->id }}</a></td>
                                <td class="text-right"><a
                                            href='{{route('teachers.show',$teacher->id)}}'>{{ $teacher->full_name }}</a>
                                </td>

                                <td class="text-right"><a
                                            href="{{route("schools.show",$teacher->school_id)}}">{{ $teacher->name }}</a>
                                </td>
              ...
              "وزارة التربية و التعليم"
                                ...
                                <td class="text-right"> {{ $school->rate}} </td>
                                <td class="text-right">
