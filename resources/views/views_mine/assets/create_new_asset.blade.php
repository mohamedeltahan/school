            ...
            <div class="form-container col-md-6 col-md-offset-3">
                <form method="post" action="{{route('assets.store')}}">
					...
					<div class="form-group">
						...
						<input name="date_released" type="text" class="form-control birth-date-input-field">
					</div><!-- /.form-group -->

					<div class="form-group">
						<label>تاريخ الانتهاء</label>
						<input name="expired_date" type="text" class="form-control birth-date-input-field">
					</div><!-- /.form-group -->
